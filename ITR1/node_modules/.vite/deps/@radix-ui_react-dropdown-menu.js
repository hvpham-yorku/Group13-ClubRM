...
import {
  useDirection
} from "./chunk-A2QOA266.js";
import {
  Combination_default,
  FocusScope,
  hideOthers,
  useFocusGuards
} from "./chunk-XVNNQW5P.js";
import {
  Anchor,
  Arrow,
  Content,
  Root2,
  createPopperScope
} from "./chunk-XN5SGLDL.js";
import "./chunk-WOVQ4D4X.js";
import {
  DismissableLayer,
  Portal,
  useId
} from "./chunk-UI22OLHY.js";
import {
  useControllableState
} from "./chunk-MGFHXAYW.js";
import {
  Presence,
  composeEventHandlers
} from "./chunk-HBZ7QTJJ.js";
import {
  useCallbackRef
} from "./chunk-HMCV2263.js";
import "./chunk-EEXMREQD.js";
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React11.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime12.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React11.isValidElement(newElement) ? React11.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable4(child) {
  return React11.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
var MenuGroup = React14.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(Primitive2.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = React14.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(Primitive2.div, { ...labelProps, ref: forwardedRef });
  }
);
